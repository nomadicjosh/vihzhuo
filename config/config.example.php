...
return [
    /*
     ...
     |--------------------------------------------------------------------------
     |
     | General settings for configuring Vihzhuo.
     | If you install Vihzhuo with Composer, general.assets_url line must be:
     | 'assets_url' => '/vendor/nomadicjosh/vihzhuo/dist',
     |
     */
    'general' => [
    ...
    'auth' => [
        'use_login' => true,
        'class' => Vihzhuo\Modules\Auth\Auth::class,
        'url' => '/admin/auth',
        'username' => 'admin',
