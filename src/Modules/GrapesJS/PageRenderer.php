...
class PageRenderer
{
     ...
     *
     * @var int|float $cacheLifetime
     */
    public static int|float $cacheLifetime = 7*24*60;
     ...
     * @throws Exception
     */
    public function renderBlock($slug, $id = null, $context = null, int $maxDepth = 25): string
    {
     ...
     * @param array|null $context                    the data for each block to be used while parsing the shortcodes
     * @return string
     * @throws Exception
     */
